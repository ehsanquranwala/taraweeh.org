...
mysqli_select_db($connDoraTarjumaQuran, $database_connDoraTarjumaQuran);
$query_rs_Place = "SELECT pl.PlaceId, pl.Address FROM place pl join program pr WHERE pr.PlaceId=pl.PlaceId and pr.HijriYear=1428 and (pl.WikimapiaLink='' or pl.WikimapiaLink<=>null) and CityTown ='".$DefaultCityTown."' order by Address";
...
<script language="javascript" type="text/javascript">
	...
	function getScriptPage(ce)
	{
		...
		reqstr="script_selectcurrentplace.php?co="+escape(co)+"&re="+escape(re)+"&ci="+escape(ci)+"&ce="+escape(ce);
