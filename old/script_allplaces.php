<?php
	...
	$query3="Select distinct(CityTown) from place where CityTown!='Other' and Country='".$SelectedCountry."' and Region='".$SelectedRegion."'";
	$res3=$ds->get_array($query3);
	if((!strcmp($ChangedEntry,'cn'))or(!strcmp($ChangedEntry,'re')))$SelectedCityTown=$res3[0];
	$query4="Select distinct(Address), PlaceId from place Where Country='".$SelectedCountry."' and Region='".$SelectedRegion."' and CityTown='".$SelectedCityTown."'";
