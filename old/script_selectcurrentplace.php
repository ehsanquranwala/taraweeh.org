<?php
	...
	$query4="Select pl.Address, pl.PlaceId from place pl join program pr WHERE pr.PlaceId=pl.PlaceId and pr.HijriYear=1428 and (pl.WikimapiaLink='' or pl.WikimapiaLink<=>null) and Country='".$SelectedCountry."' and Region='".$SelectedRegion."' and CityTown='".$SelectedCityTown."' order by Address";
